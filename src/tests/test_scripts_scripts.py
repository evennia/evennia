...
class TestExtendedLoopingCall(unittest.TestCase):
    ...
    # extended_looping_call.start(interval, now, start_delay, count_start))
        assert True  # TODO: implement your test here
...
# inherited from ScriptBase
    def test___eq__(self):
        self.assertTrue(create_script(DoNothing), self.scr)

    def test_at_init(self):
        # Need to force a server reload?
        # script_base = ScriptBase()
        # self.assertEqual(expected, script_base.at_init())
        assert True  # TODO: implement your test here

# Why defined on Script and ScriptBase?
...
#        assert True  # TODO: implement your test here
    ...
    def test___init__(self):
        # Don't use this, use create_script()
        # script = Script(dbobj)
        assert True  # TODO: implement your test here

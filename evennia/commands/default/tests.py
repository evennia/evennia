...
class TestCallMultiReceivers(CommandTest):
    def test_say(self):
        receivers = {
            self.char1: 'You say, "Testing"',
            self.char2: 'Char says, "Testing"',
            self.obj1: 'Char says, "Testing"'
        }
        # test passed messages
        cmd_result = self.call_multi_receivers(general.CmdSay(), "Testing", receivers)
        # test the string the method returns
        wnt_msg = 'You say, "Testing"Char says, "Testing"Char says, "Testing"'
        self.assertEqual(cmd_result, wnt_msg)

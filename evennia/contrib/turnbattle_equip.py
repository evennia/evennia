...
your game's character.py module:
    ...
    from evennia.contrib.turnbattle_equip import BattleCharacter
...
Next, import this module into your default_cmdsets.py module:
    ...
    from evennia.contrib import turnbattle_equip
...
And add the battle command set to your default command set:
    ...
    #
    self.add(turnbattle_equip.BattleCmdSet())
...
class CmdWield(Command):
    ...
    def func(self):
        ...
        if not weapon:
            return
        if not weapon.is_typeclass("evennia.contrib.turnbattle_equip.Weapon"):
...
class CmdDon(Command):
    ...
    def func(self):
        ...
        if not armor:
            return
        if not armor.is_typeclass("evennia.contrib.turnbattle_equip.Armor"):
...
BASEWEAPON = {
 "typeclass": "evennia.contrib.turnbattle_equip.Weapon",
}

BASEARMOR = {
 "typeclass": "evennia.contrib.turnbattle_equip.Armor",
}

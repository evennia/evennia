...
class DefaultAccount(with_metaclass(TypeclassBase, AccountDB)):
    ...
    * Hook methods
    ...
    def return_examine(self, viewer, *args, **kwargs):
        """
        Generates basic information about Accounts for @examine to see.
        Args:
        ...
        message.append(f"|wEmail|n: |c{self.email}|n")
        ...
        message.append(f"|wPermissions|n: {perms_string}")
    ...
    def return_examine_commands(self, viewer, cmdsets, *args, **kwargs):
        """
        Separated from return_examine simply because it's huge. This renders
        the available commands for this Typed Object.

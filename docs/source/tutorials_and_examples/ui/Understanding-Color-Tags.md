...
Correct understanding of this topic requires having read the [TextTags](../../evennia_core/system/ui/TextTags) page and learned Evennia's color tags. Here we'll explain by examples the reasons behind the unexpected (or apparently incoherent) behaviors of some color tags, as mentioned _en passant_ in the [TextTags](../../evennia_core/system/ui/TextTags) page.
